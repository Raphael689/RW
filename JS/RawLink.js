...
(function () {
  ...
  function openLoonLink() {
        // 提取
        const loonUrl = window.location.href.replace("/blob", "").replace("raw.githubusercontent.com", "www.nsloon.com/openloon/import?plugin=https://raw.githubusercontent.com");
        window.open(loonUrl, "_blank");
  }

  function openSurgeLink() {
        // 提取
        const surgeUrl = window.location.href.replace("/blob", "").replace("raw.githubusercontent.com", "api.boxjs.app/surge/install-module?url=https://raw.githubusercontent.com");
